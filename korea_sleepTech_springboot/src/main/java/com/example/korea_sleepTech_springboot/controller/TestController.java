...
public class TestController {
    ...
    @PostMapping
    public A_TestEntity createTest(@RequestBody A_TestEntity testEntity) {
        A_TestEntity test = testService.createTest(testEntity);
        return test;
    }

    @PutMapping
    public A_TestEntity updateTest(@PathVariable Long id, @RequestBody A_TestEntity testEntity) {
        return null;
    }
