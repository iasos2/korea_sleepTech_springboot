...
// : 기본 생성자 생성
//      - AccessLevel.PROTECTED를 통해 외부에서 new 키워드로 객체 생성이 불가
//      - JPA 는 기본 생성자가 반드시 필요하지만 외부에서 임의 생성 방지
@Getter
public class User implements UserDetails {
    ...
    @Column(name = "id", updatable = false) // DB 컬럼명 설정, updatable = false를 통해 수정 불가 설정
    private Long id;
