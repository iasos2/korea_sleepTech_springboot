...
public class ResponseDto<D> {
    ...
    // 성공 응답 생성
    public static <D> com.example.korea_sleepTech_springboot.dto.response.ResponseDto<D> setSuccess(String message, D data) {
        return com.example.korea_sleepTech_springboot.dto.response.ResponseDto.set(true, message, data);
    }

    // 실패 응답 생성
    public static <D> ResponseDto<?> setFailed(String message) {
        return com.example.korea_sleepTech_springboot.dto.response.ResponseDto.set(false, message, null);
    }
}
